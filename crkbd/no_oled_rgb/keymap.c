...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------------+-------------+-------------+-------------+-------------+-------------+                    +-------------+-------------+-------------+-------------+-------------+-------------|
        _______,      _______,      RGB_SAI,      RGB_VAI,     RGB_HUI,      RGB_TOG,                            _______,      _______,      _______,      _______,      _______,      _______,  \
  //|-------------+-------------+-------------+-------------+-------------+-------------+                    +-------------+-------------+-------------+-------------+-------------+-------------|
        _______,      _______,      RGB_SAD,      RGB_VAD,     RGB_HUD,      RGB_MOD,                            _______,      _______,      _______,      _______,      _______,      _______,  \
  //|-------------+-------------+-------------+-------------+-------------+-------------+--------|  |--------+-------------+-------------+-------------+-------------+-------------+-------------|
                                                               _______,      LOWER,      SHFT_BS,     KC_SPC,    RAISE,        _______   \
  //                                                        |-------------+-------------+--------|  |--------+-------------+-------------|
  )
};
